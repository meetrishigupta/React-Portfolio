    ...
    return (
      <>
        <header className="bg-gray-800 md:sticky top-0 z-10">
          ...
          {/* <a href="#about" className="title-font font-medium text-white mb-4 md:mb-0 ml-3 text-xl hidden md:block">
  Rishi Gupta
</a> */}
<nav className="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-700 flex flex-wrap items-center text-base justify-center">
    ...
    <a href="#testimonials" className="mr-5 hover:text-white hidden md:block">
        Certifications
    </a>
</nav>
